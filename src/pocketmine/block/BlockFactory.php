...
class BlockFactory{
	...
	public static function init() : void{
		self::$fullList = new \SplFixedArray(1024 << 4);

		self::$light = \SplFixedArray::fromArray(array_fill(0, 1024 << 4, 0));
		self::$lightFilter = \SplFixedArray::fromArray(array_fill(0, 1024 << 4, 1));
		self::$solid = \SplFixedArray::fromArray(array_fill(0, 1024 << 4, 0));
		self::$hardness = \SplFixedArray::fromArray(array_fill(0, 1024 << 4, 0));
		self::$transparent = \SplFixedArray::fromArray(array_fill(0, 1024 << 4, 0));
		self::$diffusesSkyLight = \SplFixedArray::fromArray(array_fill(0, 1024 << 4, false));
		self::$blastResistance = \SplFixedArray::fromArray(array_fill(0, 1024 << 4, 0.0));
